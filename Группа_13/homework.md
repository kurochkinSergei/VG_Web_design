...
============================
- gДан массив произвольной длины, содержащий целые положительные числа, например A = [9,0,123,82,17]. Написать функцию (именно функцию), которая выведет в консоль наибольший и наименьший элемент массива. Пример вывода: "max - 123, min - 0"
